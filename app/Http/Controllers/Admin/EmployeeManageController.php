...
class EmployeeManageController extends Controller
{
    ...
    public function update(Request $request, string $id)
    {
        ...
        return redirect()->route('employees.index')->with('success', ucfirst($this->role) . ' updated successfully.');
    }
    ...
    public function destroy(string $id)
    {
        ...
        return redirect()->route('employees.index')->with('success', ucfirst($this->role) . ' deleted successfully.');
    }
}
