...
class HrManageController extends Controller
{
    ...
    public function index(Request $request)
    {
        if ($request->ajax()) {
            ...
            foreach ($users as $user) {
                ...
                $data[] = [
                    'name' => $media,
                    'role' => '<p class="mb-0">' . strtoupper($this->role) . '</p><span class="text-success">Management</span>',
        ...
        return view($this->viewPath . '.index', [
            ...
            'title' => $this->title,
            "breadcrumbs" => ["Dashboard", "Users", strtoupper($this->role)],
            'simplePage' => 0,
            'scrollspy' => 0,
        ]);
    }
    ...
    public function create()
    {
        return view($this->viewPath . '.create', [
            'catName' => 'users',
            'role' => $this->role,
            'title' => 'Create ' . strtoupper($this->role),
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('hrs.index')->with('success', strtoupper($this->role) . ' created successfully.');
    }
    ...
    public function edit(string $id)
    {
        ...
        return view($this->viewPath . '.edit', [
            ...
            'catName' => 'users',
            'role' => $this->role,
            'title' => 'Edit ' . strtoupper($this->role),
    ...
    public function update(Request $request, string $id)
    {
        ...
        return redirect()->route('hrs.index')->with('success', strtoupper($this->role) . ' updated successfully.');
    }
    ...
    public function destroy(string $id)
    {
        ...
        return redirect()->route('hrs.index')->with('success', strtoupper($this->role) . ' deleted successfully.');
    }
}
