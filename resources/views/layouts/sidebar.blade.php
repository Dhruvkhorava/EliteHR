    ...
    <nav id="sidebar">
        ...
        <ul class="list-unstyled menu-categories" id="accordionExample">
            ...
            <li class="menu {{ Request::routeIs('attendance.*') ? 'active' : '' }}">
                <a href="#attendance" data-bs-toggle="collapse" aria-expanded="{{ Request::routeIs('attendance.*') ? 'true' : 'false' }}" class="dropdown-toggle">
                    <div class="">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-calendar"><rect x="3" y="4" width="18" height="18" rx="2" ry="2"></rect><line x1="16" y1="2" x2="16" y2="6"></line><line x1="8" y1="2" x2="8" y2="6"></line><line x1="3" y1="10" x2="21" y2="10"></line></svg>
                ...
                <ul class="collapse submenu list-unstyled {{ Request::routeIs('attendance.*') ? 'show' : '' }}" id="attendance" data-bs-parent="#accordionExample">
            ...
            <li class="menu {{ $catName == 'leave' ? 'active' : '' }}">
                <a href="#leave" data-bs-toggle="collapse" aria-expanded="{{ $catName == 'leave' ? 'true' : 'false' }}" class="dropdown-toggle">
                    <div class="">
                ...
                <ul class="collapse submenu list-unstyled {{ $catName == 'leave' ? 'show' : '' }}" id="leave" data-bs-parent="#accordionExample">
            ...
            <li class="menu {{ Request::is('dashboard/payroll*') ? 'active' : '' }}">
                <a href="#payroll" data-bs-toggle="collapse" aria-expanded="{{ Request::is('dashboard/payroll*') ? 'true' : 'false' }}" class="dropdown-toggle">
                    <div class="">
                ...
                <ul class="collapse submenu list-unstyled {{ Request::is('dashboard/payroll*') ? 'show' : '' }}" id="payroll" data-bs-parent="#accordionExample">
            ...
            <li class="menu {{ $catName == 'performance' ? 'active' : '' }}">
                <a href="#performance" data-bs-toggle="collapse" aria-expanded="{{ $catName == 'performance' ? 'true' : 'false' }}" class="dropdown-toggle">
                    <div class="">
                ...
                <ul class="collapse submenu list-unstyled {{ $catName == 'performance' ? 'show' : '' }}" id="performance" data-bs-parent="#accordionExample">
            ...
            <li class="menu {{ Request::is('dashboard/recruitment*') ? 'active' : '' }}">
                <a href="#recruitment" data-bs-toggle="collapse" aria-expanded="{{ Request::is('dashboard/recruitment*') ? 'true' : 'false' }}" class="dropdown-toggle">
                    <div class="">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-user-plus"><path d="M16 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2"></path><circle cx="9" cy="7" r="4"></circle><line x1="19" y1="8" x2="19" y2="14"></line><line x1="22" y1="11" x2="16" y2="11"></line></svg>
                ...
                <ul class="collapse submenu list-unstyled {{ Request::is('dashboard/recruitment*') ? 'show' : '' }}" id="recruitment" data-bs-parent="#accordionExample">
            ...
            <li class="menu {{ $catName == 'communication' ? 'active' : '' }}">
                <a href="javascript:void(0);" aria-expanded="false" class="dropdown-toggle">
                    <div class="">
