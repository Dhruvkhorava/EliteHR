        ...
        <ul class="navbar-item theme-brand flex-row text-center">
            <li class="nav-item theme-logo">
                <a href="{{getRouterValue()}}dashboard/analytics">
                    <img src="{{asset('asset/images/logo.png')}}" class="logo-light navbar-logo-g" alt="logo">
                    <img src="{{asset('asset/images/logo.png')}}" class="logo-dark navbar-logo-g" alt="logo">
                </a>
            </li>
            <li class="nav-item theme-text">
                <a href="{{getRouterValue()}}dashboard/analytics" class="nav-link"> EliteHR </a>
            </li>
        </ul>
                ...
                <a href="javascript:void(0);" class="nav-link dropdown-toggle user" id="userProfileDropdown" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                    <div class="avatar-container">
                        <div class="avatar avatar-sm avatar-indicators avatar-online">
                            <img alt="avatar" src="{{ (Auth::check() && Auth::user()->image) ? asset('storage/' . Auth::user()->image) : asset('asset/images/placeholder.png') }}" class="rounded-circle">
                        </div>
                    </div>
                </a>
