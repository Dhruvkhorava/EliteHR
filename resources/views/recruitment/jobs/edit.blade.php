                ...
                <div class="widget-content p-4">
                    <div class="w-header mb-4 d-flex justify-content-between align-items-center">
                        <div class="w-info text-primary font-weight-bold">
                            <h4 class="value text-primary mb-1">Edit Job Opening</h4>
                        </div>
                    ...
                    <form action="{{ route('recruitment.jobs.update', $job->id) }}" method="POST">
                        @csrf
                        @method('PUT')
                        <div class="row">
